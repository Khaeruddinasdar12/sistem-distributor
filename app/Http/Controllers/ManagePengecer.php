...
class ManagePengecer extends Controller
{
	...
	{
		return view('manage-pengecer.index');
	}

    public function store(Request $request) // tambah data pengecer
    {	
    	...
    	return $arrayName = array(
    		'status' => 'success',
    		'pesan' => 'Berhasil Menambah Pengecer.'
    	);
    }
	...
	public function update(Request $request) //ubah data admin
	{
		...
		return $arrayName = array(
			'status' => 'success',
			'pesan' => 'Berhasil mengubah data pengecer'
		);
	}
