    ...
    <div class="col-12">
      ...
      <div class="card">
        <div class="card-header">
          <h2 class="card-title"><i class="fa fa-user-cog"></i> Manage Peternak</h2>
        </div>
        <!-- /.card-header -->
        <div class="card-body">
          <div class="card">
            ...
            <div class="float-right">
              <button class="btn btn-primary" data-toggle="modal" data-target="#tambah-admin"><i class="fa fa-plus"></i> Tambah Peternak</button>
            </div> 
            <br>
            <br>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Edit Data Peternak</h5>
  ...
  tabel = $(document).ready(function(){
    $('#tabel_admin').DataTable({
      ...
      "ordering": true,
        ...
        "ajax":  {
                "url":  '{{route("table.peternak")}}', // URL file untuk proses select datanya
                "type": "GET"
              },
              "columns": [
