    ...
    <div class="col-12">
      ...
      <div class="card">
        <div class="card-header">
          <h2 class="card-title"><i class="fa fa-cloud-meatball"></i> Manage Pakan</h2>
        </div>
        <!-- /.card-header -->
        <div class="card-body">
          <div class="card">
            ...
            <div class="float-right">
              <button class="btn btn-primary" data-toggle="modal" data-target="#tambah-admin"><i class="fa fa-plus"></i> Tambah Pakan</button>
            </div> 
            <br>
            <br>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Edit Data Pakan</h5>
...
<script type="text/javascript">
  ...
  $('#edit-pengecer').submit(function(e){ //edit pengecer
    ...
    var endpoint= '{{route("manage.pakan.update")}}';
    $.ajax({
      url: endpoint,
      method: "POST",
      data: request,
  ...
  $('#add').submit(function(e){ // tambah obat
    ...
    var request = new FormData(this);
    var endpoint= '{{route("manage.pakan.store")}}';
    // alert('hai');
    $.ajax({
      url: endpoint,
      method: "POST",
  ...
  tabel = $(document).ready(function(){
    $('#tabel_admin').DataTable({
      ...
      "ordering": true,
        ...
        "ajax":  {
                "url":  '{{route("table.pakan")}}', // URL file untuk proses select datanya
                "type": "GET"
              },
              "columns": [
